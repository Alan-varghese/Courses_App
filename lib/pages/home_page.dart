...
import 'package:march_app/widgets/bottom_navigation_bar.dart';
import 'package:march_app/widgets/course_card.dart';
import 'package:march_app/widgets/hexagon_custom_clipper.dart';
import 'package:march_app/widgets/traingle_custom_clipper.dart';
          ...
          Positioned.fill(
            child: Column(
              children: [
                Expanded(
                  flex: 6,
                  child: Container(color: CoursesColors.veryLightGreen),
                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Learners',
                                  style: TextStyle(
                                    color: CoursesColors.darkGreen.withOpacity(
                                      .7,
                                    ),
                                    fontSize: 18,
                                    fontWeight: FontWeight.w400,
